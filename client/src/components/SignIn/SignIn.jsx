    ...
    return (
        <div className="signin">
            ...
            <div className="mainForm">
                ...
                <div className="longBtn signinFacebook">
                    <button>CONTINUE WITH FACEBOOK</button>
                </div>
                <div className="longBtn signinApple">
                    <button>CONTINUE WITH APPLE</button>
                </div>
                <div className="longBtn signinGoogle">
                    <button>CONTINUE WITH GOOGLE</button>
                </div>
                <div className="longBtn signinPhone">
                    <button>CONTINUE WITH PHONE NUMBER</button>
                </div>
                <hr/>
                <form onSubmit={(e) => register(e)} className="formData">
                    <div className="inputField">
                        <label htmlFor="html">Email address or username</label>
                        <input onChange={(e) => handel(e)} type="text" placeholder="Email address or username" name="f" id="email" />
                    </div>
                    <div className="inputField">
                    ...
                    <hr/>
                    <p className="extraText">Don't have an account?</p>
                    <div className="longBtn submit">
