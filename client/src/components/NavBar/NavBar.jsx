        ...
        <div className="NavBar">
            ...
            <ul>
                ...
                <Link to="/library">
                    <li>
                        <span className="icon">
                            <div className="ic" style={{backgroundColor:"white"}}>
                                <svg role="img" height="12" width="12" viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 gSLhUO"><path d="M14 7H9V2H7v5H2v2h5v5h2V9h5z"></path><path fill="none" d="M0 0h16v16H0z"></path></svg>
                            </div>
                        </span>
                        <span className="title">
                            Create Playlist
